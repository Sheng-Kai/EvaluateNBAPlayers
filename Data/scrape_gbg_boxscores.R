...
rS <- c("2010-10-26", "2012-01-02", "2012-10-30", "2013-10-29", "2014-10-28")
rE <- c("2011-04-13", "2012-01-31", "2013-04-17", "2014-04-16", "2015-04-15")
...
for(iy in 2010){
    ...
    for (i in seq_along(days)){
        ...
        if(indexStart[1] == -1){
            ...
            for(ig in 1:length(gamehtml)){
                ...
                print(paste0(paste0(setDate,":"), "prepare to download"))
                ...
                print(paste0(paste0(setDate,":"), "downloaded"))
    ...
    fileName <- paste0("NBADATA_gbg_Dirty_2012_01.csv")
    write.csv(seasonBoxscores.df, fileName, row.names = FALSE)
}

toc <- Sys.time()
difftime(toc, tic, units = c("mins"))
